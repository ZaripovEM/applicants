...
import './CalendarBacCorresBudg.css'
...
const CalendarBacFullBudg = () => {
	return (
		<div>
			<h1>
				Бакалавриат / Специалитет – Очная форма обучения – Бюджетные места
			</h1>
...
export default CalendarBacFullBudg
